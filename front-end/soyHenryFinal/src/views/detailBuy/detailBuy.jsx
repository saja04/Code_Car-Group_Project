  ...
  if (!isAuthenticated) {
    ...
    if (medioDePago === 'efectivo') {
      try {
        ...
        console.log('Información del automóvil:', carName, carPrice, medioDePago);

        const response = await axios.post('https://codecar.onrender.com/createOrderCar', {
          userId: user.sub,
      ...
      try {
        ...
        const response = await axios.post(`https://codecar.onrender.com/create-order/?name=${carName}&price=${carPrice}`);
    ...
    return (
        <div className={style["detail-buy-container"]}>
            ...
            <div className={style["car-details"]}>
                ...
                {carDetails && (
                    <>
                        <p>{carDetails.car_marca} {carDetails.car_modelo}</p>
